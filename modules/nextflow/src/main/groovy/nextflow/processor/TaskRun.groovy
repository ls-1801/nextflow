...
class TaskRun implements Cloneable {
    ...
    static final public String CMD_STRACE = '.strace'
    static final public String CMD_TRACE_INPUTS = '.inputs.trace'
    static final public String CMD_TRACE_OUTPUTS = '.outputs.trace'
